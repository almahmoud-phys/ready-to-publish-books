---
chapter: 10
title: La luz, otra vez
promise: Read a full mixed-tense story and explain why people acted
builds_on: [9]
sets_up: []
word_budget: 900
key_claims: ["Nearly a year has passed since story 01", "The light is Doña Lucía's annual lamp", "She posts one letter to the sea each year", "The explanation is ordinary and resolves nothing emotionally", "Ana speaks the truth publicly", "Beto stays", "The phrase 'no hay nada' is absent"]
sources_needed: [invented fiction only; no external sources; cast, places and bible/letters-causal-ledger.md]
---

# Story 10 — La luz, otra vez

## Reader promise

Read a full mixed-tense story and explain why people acted.

## Local dramatic contract

- **Goal:** Nearly a year after the opening, Ana rows out to the light instead of watching it, on the next anniversary.
- **Obstacle:** It is night and she has never taken a boat out alone.
- **Turn:** The light is a lamp in Doña Lucía's boat. Once a year she rows out and puts one letter in the water — not because she thinks he drowned, but because the sea is the only thing in Puerto Lento that never says 'no hay nada'.
- **Ending:** Ana rows back and tells Beto the truth, out loud, in front of Rosa. Nobody falls apart. Beto does not leave on the next boat: the town he was leaving was one where nothing was ever said. Nobody says 'no hay nada' in this story.
...
**None.** This story measures reading, not learning.

**Allowed in this story — the CUMULATIVE union of stories 01–10:**
...
- 09: irregular preterite **[A2]**, licensed BY LEMMA in the first and third person singular only:
  `ser`/`ir` (fui, fue), `tener`, `decir`, `hacer`, `estar`, `poder`, `venir`, `querer`.
  (Corrected 2026-08-13: the contract previously licensed eight third-person FORMS while the prose
  also uses `dije` and `pude`. Licensing is by lemma plus person; second person and plurals stay out.)
- 10: **none.** This story measures reading, not learning.
...
- Nearly a year has passed since story 01; the light is Doña Lucía's next annual lamp
- She posts one letter to the sea each year
- The explanation is ordinary and resolves nothing emotionally
- Ana speaks the truth publicly
- Beto stays
- The phrase 'no hay nada' is absent

## Acceptance criteria

- [ ] Spanish narrative within ±10% of 900 words
