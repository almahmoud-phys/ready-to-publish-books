---
chapter: 07
title: Está pasando algo
promise: Follow two things happening at once
builds_on: [6]
sets_up: [8]
word_budget: 750
key_claims: ["Doña Lucía leaves the letters", "Ana catches her and says nothing", "The question is no longer who, but why", "An ordinary boat light distracts Ana while she watches the door"]
sources_needed: [invented fiction only; no external sources; cast, places and bible/letters-causal-ledger.md]
---

# Story 07 — Está pasando algo

## Reader promise

Follow two things happening at once.

## Local dramatic contract

- **Goal:** Ana decides to wait inside the kiosk all night and see who comes.
- **Obstacle:** She must choose: watch the door, or watch an ordinary boat light moving on the water.
- **Turn:** She chooses the door. While she is watching it, Doña Lucía is putting a letter on the counter — and sees Ana seeing her.
- **Ending:** LOCAL CLOSURE: the mystery of WHO is over, in the middle of the volume, deliberately. Neither woman speaks. Doña Lucía leaves the letter anyway. Ana lets her.
...
present progressive (`estar` + gerundio) **[A2]**; simultaneous action; `mientras` **[unlevelled]**

**Allowed in this story — the CUMULATIVE union of stories 01–07:**
...
- Doña Lucía leaves the letters
- Ana catches her and says nothing
- The question is no longer who, but why
- An ordinary boat light moves on the water the same night; it is not Lucía's annual lamp
