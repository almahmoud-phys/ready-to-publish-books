---
chapter: 04
title: Todos los días lo mismo
promise: Track a daily routine and notice what breaks it
builds_on: [3]
sets_up: [5]
word_budget: 650
key_claims: ["Miguel keeps Tomás's papers in the shed", "The town has never declared Tomás gone", "'No hay nada' is a refusal, not a lie", "Miguel says it too"]
sources_needed: [invented fiction only; no external sources; cast, places and bible/letters-causal-ledger.md]
---

# Story 04 — Todos los días lo mismo

## Reader promise

Track a daily routine and notice what breaks it.

## Local dramatic contract

- **Goal:** Ana wants to return the letter to whoever left it, and plans her day around catching them.
- **Obstacle:** To catch someone who comes before dawn she must break her own routine — and the town notices.
- **Turn:** She wakes at four and finds the shed already open, Miguel inside, going through a box of old papers with Tomás's name on it.
- **Ending:** LOCAL CLOSURE: Miguel tells her the truth — the town keeps Tomás's things because nobody will decide he is gone. He says 'no hay nada' too. Ana understands the phrase is not a lie; it is a refusal.
...
reflexive routine verbs; time-of-day expressions; frequency adverbs **[A1]**; habitual present **[A2]**

**Allowed in this story — the CUMULATIVE union of stories 01–04:**
...
- Miguel keeps Tomás's papers in the shed
- The town has never declared Tomás gone
- 'No hay nada' is a refusal, not a lie
- Miguel says it too
