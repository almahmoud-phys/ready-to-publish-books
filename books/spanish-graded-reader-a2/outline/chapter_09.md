...
promise: Read the past with irregular verbs
builds_on: [8]
sets_up: [10]
word_budget: 800
key_claims: ["Tomás was on the list but did not board", "He left by road that morning", "Doña Lucía never corrected the town", "Ana keeps both secrets"]
sources_needed: [invented fiction only; no external sources; cast, places and bible/letters-causal-ledger.md]
---

# Story 09 — Nadie dijo nada

## Reader promise

Read the past with irregular verbs.

## Local dramatic contract

- **Goal:** Ana goes to Doña Lucía to give the letters back.
- **Obstacle:** Doña Lucía does not want them back, and tells Ana why in a version that contradicts Rosa's on one fact.
- **Turn:** She says Tomás was on the list but did not go. He left that morning, on the road, and never came back either. She has never told the town, because a son lost at sea is mourned and a son who walked away is not.
- **Ending:** LOCAL CHOICE WITH CONSEQUENCE: Ana keeps her confidence too. She does not tell Rosa. She now holds both women's secrets and has become the person the town was protecting itself from — someone who knows.
...
irregular preterite **[A2]**, by lemma, first and third person singular only

**Allowed in this story — the CUMULATIVE union of stories 01–09:**
...
- Tomás was on the list but did not board
- He left by road that morning
- Doña Lucía never corrected the town
- Ana keeps both secrets

## Acceptance criteria

- [ ] Spanish narrative within ±10% of 800 words
