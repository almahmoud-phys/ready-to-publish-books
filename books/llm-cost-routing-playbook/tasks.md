# Tasks — LLM Cost Routing Playbook
...
- **Book:** `llm-cost-routing-playbook`
- **Lifecycle status:** Stage 0 — sample fixture; PIVOT and rerun required
- **Current focus:** None. This workspace validates the repository and is not publication-authorized.
- **Next handoff:** Human reactivation only; then repair evidence portability before rerunning Stage 0.
